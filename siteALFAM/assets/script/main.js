...
let cards = [
  {
    id: 1,
    image: "assets/images/VacationCards/1.jpg",
    category: "Домик на природе",
    price: "1 654 000",
    size: 120,
    bedrooms: 2,
    baths: 2,
  ...
  {
    id: 2,
    image: "assets/images/VacationCards/2.jpg",
    category: "Коттедж с баней",
    price: "3 500 000",
    size: 140,
    bedrooms: 5,
    baths: 2,
  ...
  {
    id: 3,
    image: "assets/images/VacationCards/3.jpg",
    category: "Элитный загородный дом",
    price: "4 404 900",
    size: 171,
    bedrooms: 5,
    baths: 2,
  ...
  {
    id: 4,
    image: "assets/images/VacationCards/4.jpg",
    category: "Мини-домик у озера",
    price: "2 430 000",
    size: 108,
    bedrooms: 2,
    baths: 2,
  ...
  {
    id: 5,
    image: "assets/images/VacationCards/5.jpg",
    category: "Семейный коттедж",
    price: "2 468 000",
    size: 102,
    bedrooms: 4,
    baths: 2,
  ...
  {
    id: 6,
    image: "assets/images/VacationCards/6.jpg",
    category: "Домик у леса",
    price: "2 586 000",
    size: 101,
    bedrooms: 4,
    baths: 2,
  ...
  {
    id: 7,
    image: "assets/images/VacationCards/7.jpg",
    category: "Стильный коттедж",
    price: "1 654 000",
    size: 120,
    bedrooms: 2,
    baths: 2,
  ...
  {
    id: 8,
    image: "assets/images/VacationCards/8.jpg",
    category: "Дачный домик",
    price: "2 393 000",
    size: 108,
    bedrooms: 5,
    baths: 2,
  ...
  {
    id: 9,
    image: "assets/images/VacationCards/9.jpg",
    category: "Загородный особняк",
    price: "3 500 000",
    size: 140,
    bedrooms: 5,
    baths: 2,
  ...
  {
    id: 10,
    image: "assets/images/VacationCards/10.jpg",
    category: "VIP-вилла",
    price: "2 588 000",
    size: 110,
    bedrooms: 6,
...
const mainPage = `<div class="main">
        <div class="container">
          <div class="good_home_left">
            <h1 class="home_title">ПРОФЕССИОНАЛЬНОЕ<br />ПЛАНИРОВАНИЕ<br />СЕМЕЙНОГО<br />ОТДЫХА </h1>
      ...
      <div class="doverie_block">
        <div class="container">
          ...
          <div class="doverie_cards">
            <div class="dov_card">
              <div class="dov_image"><i class="fas fa-child"></i></div>
              <p class="dov_title">Семейный подход</p>
              <p class="dov_subtitle">Мы понимаем потребности семей с детьми любого возраста.</p>
            </div>
            <div class="dov_card">
              <div class="dov_image"><i class="fas fa-ruble-sign"></i></div>
              <p class="dov_title">Лучшие цены</p>
              <p class="dov_subtitle">Специальные условия от наших партнеров.</p>
            </div>
            <div class="dov_card">
              <div class="dov_image"><i class="fas fa-shield-alt"></i></div>
              <p class="dov_title">Надежность</p>
              <p class="dov_subtitle">Все договоры и гарантии официально.</p>
            </div>
          </div>
          ...
          <div class="swiper-wrapper">
            <div class="employ_card swiper-slide">
              <div class="employ_avatar">
                <img src="assets/images/EmployAvatar/Robert_Hendz.jpg" alt="avatar" />
              </div>
              <p class="employ_name">Роберт Хендз</p>
              <p class="employ_category">Организатор семейных путешествий</p>
              <p class="employ_desc">
                Роберт — опытный организатор туров. Путешествует с семьёй по выходным и знает, как сделать отдых комфортным даже с маленькими детьми.
              </p>
            </div>

            <div class="employ_card swiper-slide">
              <div class="employ_avatar">
                <img src="assets/images/EmployAvatar/Lorin_James.jpg" alt="avatar" />
              </div>
              <p class="employ_name">Лорин Джеймс</p>
              <p class="employ_category">Организатор семейных путешествий</p>
              <p class="employ_desc">
                Лорин более 15 лет работает в компании. Очень активная и позитивная. Пришла работать в "Путешествие с ребёнком", когда её дочка только пошла в детский садик, а сейчас она уже студентка.
              </p>
            </div>

            <div class="employ_card swiper-slide">
              <div class="employ_avatar">
                <img src="assets/images/EmployAvatar/Mike_Branson.jpg" alt="avatar" />
              </div>
              <p class="employ_name">Майк Бренсон</p>
              <p class="employ_category">Организатор семейных путешествий</p>
              <p class="employ_desc">
                Майк специализируется на активном отдыхе с детьми. Любит приключения и всегда найдёт интересные маршруты даже для самых непоседливых туристов.
              </p>
            </div>

            <div class="employ_card swiper-slide">
              <div class="employ_avatar">
                <img src="assets/images/EmployAvatar/Bred_Slator.jpg" alt="avatar" />
              </div>
              <p class="employ_name">Брэт Слейтор</p>
              <p class="employ_category">Организатор семейных путешествий</p>
              <p class="employ_desc">
                Брэт присоединился к команде 7 лет назад. Его дети — главные эксперты в тестировании предложенных программ семейного отдыха. Всегда на связи!
              </p>
            </div>
          </div>
